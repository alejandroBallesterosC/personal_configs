...
```bash
/1-start user-authentication "Add user authentication with OAuth2 and JWT tokens"
```
...
| Command | Purpose |
|---------|---------|
| `/1-start <name> "<description>"` | **Start full orchestrated workflow** |
| `/2-explore <name> "<description>"` | Parallel codebase exploration (5 agents) |
| `/3-user-specification-interview <name> "<description>"` | Specification interview (40+ questions) |
...
| `/6-review-plan <name>` | Challenge plan, find gaps |
| `/7-implement <name> "<description>"` | Parallel TDD implementation |
| `/8-e2e-test <name> "<description>"` | End-to-end testing |
| `/9-review <name>` | Parallel multi-aspect review (5 agents) |
...
```bash
/continue-tdd-workflow user-authentication
```
...
- **Required**: `/ralph-loop` command for TDD implementation loops
