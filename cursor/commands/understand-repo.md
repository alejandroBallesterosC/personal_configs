...
You will perform **3 iterations** of codebase exploration using parallel subagents, persisting all findings to **docs/CODEBASE.md**.

## Phase 0: Launch Parallel Code Explorers

**Immediately launch 3 agents in parallel** to explore different aspects of the codebase simultaneously:

### Agent 1: Structure & Stack Explorer
Launch a Claude Sonnet agent and prompt:
...
**Wait for all agents to complete**, then synthesize their findings into docs/CODEBASE.md.
...
**Rules:**
- Write findings to docs/CODEBASE.md IMMEDIATELY after discovering them
- If you notice context was compacted, FIRST read docs/CODEBASE.md to restore state
...
1. **Create docs/CODEBASE.md** with initial structure and current date at the top of the file
...
1. **Read docs/CODEBASE.md** to restore context
...
### Iterations 3 through 3: Explore Open Questions
...
## Required Sections in docs/CODEBASE.md
...
- **ONLY** write to docs/CODEBASE.md
- Use **concrete file:line references** for every claim
- Prioritize **insight density** in docs/CODEBASE.md
...
2. Read docs/CODEBASE.md completely
...
2. **Synthesize findings** into docs/CODEBASE.md
