...
- `/2-explore $ARGUMENTS "<description>"` for exploration
- `/3-user-specification-interview $ARGUMENTS "<description>"` for specification
...
Next step:
/5-plan-implementation $ARGUMENTS (create implementation plan from architecture)
```
