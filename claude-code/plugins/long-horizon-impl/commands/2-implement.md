...
- `docs/long-horizon-impl/$1/implementation/$1-implementation-plan.md`
...
```
Task tool with subagent_type='long-horizon-impl:autonomous-coder'
...
Use macOS notifications with subtitle "Long Horizon Impl" for feature completion, blocks, failures, and overall completion events.
