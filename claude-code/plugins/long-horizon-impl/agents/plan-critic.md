...
- The main instance uses the BLOCKER count during 2-implement plan validation to decide whether to generate the feature list. Phase transitions in 1-research-and-plan are budget-based, not blocker-based.
