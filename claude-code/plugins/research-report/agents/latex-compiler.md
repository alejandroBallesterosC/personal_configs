---
name: latex-compiler
description: "LaTeX document formatter and compiler for research-report workflows. Formats .tex files, runs the pdflatex/bibtex compilation pipeline, and fixes compilation errors. Spawned at phase boundaries to produce PDF output."
...
```
cd /path/to/docs/research-report/<topic> && pdflatex -interaction=nonstopmode <topic>-report.tex && bibtex <topic>-report && pdflatex -interaction=nonstopmode <topic>-report.tex && pdflatex -interaction=nonstopmode <topic>-report.tex
```
