% ABOUTME: Base LaTeX template for argument-driven research reports.
% ABOUTME: Structure: front Synthesis (TL;DR), Background, body chapters with argument-style titles, back Conclusions, Open Questions, Methodology appendix.
...
%% 3. Single authorial voice across the whole report. Follow the voice
%%    guide (see the latex-report skill's voice-guide-template.md) before
%%    each chapter.
%%
%% PROSE
...
%% 10. Preserve qualifications and evidence-gap ratings from your research.
%%     If a finding only supports the prevalence claim but not the
%%     causal claim, the prose must reflect that boundary.
%% 11. Flow/engagement edit passes may improve prose but MUST NOT drop
%%     \cite{}, weaken qualifications, or turn qualified claims into
%%     unqualified ones.
%% ==========================================================================

\section{Synthesis}
% NOTE: This is the front-loaded executive summary. Write it LAST, after
% the body chapters and Conclusions are finalized, so it accurately
...
%%
%% Draft chapters one at a time, sequentially, so a single voice carries
%% through — do not draft chapters in parallel.
%%
%% Example (placeholder — replace with real chapters):
%%
...
% CHAPTERS_PLACEHOLDER — insert the dynamic body here.

\section{Conclusions \& Recommendations}
% NOTE: This is the back-loaded Conclusions. Write it AFTER all body
% chapters are drafted — the integrated argument earned by everything
% in between.
%
