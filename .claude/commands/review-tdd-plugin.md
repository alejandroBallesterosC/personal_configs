# ABOUTME: Command to conduct thorough research and review of the TDD workflow plugin
# ABOUTME: Compares plugin against best practices from Anthropic docs and power users

---
description: Research best practices and holistically review the TDD workflow plugin
model: opus
---

# Review TDD Workflow Plugin

Conduct thorough research and provide holistic feedback on the TDD workflow plugin.
...
- Official guides on TDD, testing workflows, or iterative development with Claude
...
### 3. TDD Workflow Plugin Analysis
Thoroughly explore the TDD workflow plugin at `claude-code/plugins/tdd-workflow/`:
...
Explore dependencies and related plugins that TDD workflow relies on:
- ralph-loop plugin (required for Phases 7, 8, 9)
- Other plugins in `claude-code/plugins/` that interact with TDD workflow
